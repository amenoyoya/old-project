...
class HXCPP_CLASS_ATTRIBUTES  SpriteBatch_obj : public hx::Object{
	...
	public:
		...
		virtual Void renderBitmapData( ::openfl::display::BitmapData bitmapData,bool smoothing,::openfl::geom::Matrix matrix,::openfl::geom::ColorTransform ct,Dynamic alpha,::openfl::display::BlendMode blendMode);
		...
		virtual Void fillVertices( int index,Float width,Float height,::openfl::geom::Matrix matrix,::openfl::display::TextureUvs uvs,::openfl::geom::Point pivot,Dynamic color);
