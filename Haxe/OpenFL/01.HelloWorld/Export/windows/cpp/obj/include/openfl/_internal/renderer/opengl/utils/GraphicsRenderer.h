...
class HXCPP_CLASS_ATTRIBUTES  GraphicsRenderer_obj : public hx::Object{
	...
	public:
		...
		static Void renderGraphics( ::openfl::display::DisplayObject object,::openfl::_internal::renderer::RenderSession renderSession,::openfl::geom::Point projection,Dynamic localCoords);
		...
		static ::openfl::_internal::renderer::opengl::shaders2::Shader prepareShader( ::openfl::_internal::renderer::opengl::utils::GLBucket bucket,::openfl::_internal::renderer::RenderSession renderSession,::openfl::display::DisplayObject object,::openfl::geom::Point projection,::lime::utils::Float32Array translationMatrix);
		static Dynamic prepareShader_dyn();

		static Void renderFill( ::openfl::_internal::renderer::opengl::utils::GLBucket bucket,::openfl::_internal::renderer::opengl::shaders2::Shader shader,::openfl::_internal::renderer::RenderSession renderSession,::lime::utils::Float32Array translationMatrix);
