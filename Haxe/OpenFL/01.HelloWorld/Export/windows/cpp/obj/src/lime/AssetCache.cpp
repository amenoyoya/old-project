...
{
HX_STACK_FRAME("lime.AssetCache","new",0xe0eaad7d,"lime.AssetCache.new","lime/Assets.hx",1147,0x48c77341)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(1151)
	this->enabled = true;
...
{
		HX_STACK_FRAME("lime.AssetCache","clear",0xa2398fea,"lime.AssetCache.clear","lime/Assets.hx",1167,0x48c77341)
		HX_STACK_THIS(this)
