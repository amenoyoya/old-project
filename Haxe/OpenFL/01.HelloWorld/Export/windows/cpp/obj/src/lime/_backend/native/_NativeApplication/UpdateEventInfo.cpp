...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.UpdateEventInfo","new",0x0d5fef74,"lime._backend.native._NativeApplication.UpdateEventInfo.new","lime/_backend/native/NativeApplication.hx",545,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::UpdateEventInfo UpdateEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.UpdateEventInfo","clone",0xc8041f71,"lime._backend.native._NativeApplication.UpdateEventInfo.clone","lime/_backend/native/NativeApplication.hx",555,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(555)
