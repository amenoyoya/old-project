...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\App\\Haxe-3.1.3\\haxe\\std/StringTools.hx",71,0x8156826e)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(71)
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\App\\Haxe-3.1.3\\haxe\\std/StringTools.hx",133,0x8156826e)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::hex( int n,Dynamic digits){
	HX_STACK_FRAME("StringTools","hex",0xd91debd7,"StringTools.hex","C:\\App\\Haxe-3.1.3\\haxe\\std/StringTools.hx",313,0x8156826e)
	HX_STACK_ARG(n,"n")
