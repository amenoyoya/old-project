...
::lime::graphics::RenderContext  RenderContext_obj::CONSOLE(::lime::graphics::ConsoleRenderContext context)
	{ return hx::CreateEnum< RenderContext_obj >(HX_CSTRING("CONSOLE"),4,hx::DynamicArray(0,1).Add(context)); }

::lime::graphics::RenderContext  RenderContext_obj::CUSTOM(Dynamic data)
	{ return hx::CreateEnum< RenderContext_obj >(HX_CSTRING("CUSTOM"),5,hx::DynamicArray(0,1).Add(data)); }
...
int RenderContext_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_CSTRING("CONSOLE")) return 4;
	if (inName==HX_CSTRING("CUSTOM")) return 5;
