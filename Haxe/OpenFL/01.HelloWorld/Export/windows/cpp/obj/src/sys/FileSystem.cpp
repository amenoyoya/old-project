...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_FRAME("sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","C:\\App\\Haxe-3.1.3\\haxe\\std/cpp/_std/sys/FileSystem.hx",42,0x0d68914c)
	...
	if (((s == null()))){
		...
		struct _Function_2_1{
			inline static Dynamic Block( ::Date &_g1,::Date &_g,::Date &_g2){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\App\\Haxe-3.1.3\\haxe\\std/cpp/_std/sys/FileSystem.hx",45,0x0d68914c)
				{
...
::String FileSystem_obj::fullPath( ::String relPath){
	HX_STACK_FRAME("sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","C:\\App\\Haxe-3.1.3\\haxe\\std/cpp/_std/sys/FileSystem.hx",52,0x0d68914c)
