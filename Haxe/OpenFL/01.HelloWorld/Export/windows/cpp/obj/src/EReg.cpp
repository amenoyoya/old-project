...
{
HX_STACK_FRAME("EReg","new",0x8b859e81,"EReg.new","C:\\App\\Haxe-3.1.3\\haxe\\std/cpp/_std/EReg.hx",28,0x3110e86a)
HX_STACK_THIS(this)
HX_STACK_ARG(r,"r")
...
::String EReg_obj::replace( ::String s,::String by){
	HX_STACK_FRAME("EReg","replace",0xae923ad5,"EReg.replace","C:\\App\\Haxe-3.1.3\\haxe\\std/cpp/_std/EReg.hx",98,0x3110e86a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(by,"by")
	HX_STACK_LINE(99)
