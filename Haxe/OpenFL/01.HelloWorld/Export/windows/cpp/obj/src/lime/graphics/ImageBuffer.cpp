...
{
HX_STACK_FRAME("lime.graphics.ImageBuffer","new",0xb261c9e3,"lime.graphics.ImageBuffer.new","lime/graphics/ImageBuffer.hx",39,0x6475c2cd)
HX_STACK_THIS(this)
...
::lime::graphics::ImageBuffer ImageBuffer_obj::clone( ){
	HX_STACK_FRAME("lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",50,0x6475c2cd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(52)
	...
	if (((this->data != null()))){
		HX_STACK_LINE(89)
		::lime::utils::UInt8Array _g = ::lime::utils::UInt8Array_obj::__new(this->data->byteLength,null(),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(89)
		buffer->data = _g;
		HX_STACK_LINE(90)
		::lime::utils::UInt8Array copy = ::lime::utils::UInt8Array_obj::__new(this->data,null(),null());		HX_STACK_VAR(copy,"copy");
		HX_STACK_LINE(91)
		buffer->data->set(copy,null());
	}
	HX_STACK_LINE(94)
...
Dynamic ImageBuffer_obj::get_src( ){
	HX_STACK_FRAME("lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",124,0x6475c2cd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(124)
...
Dynamic ImageBuffer_obj::set_src( Dynamic value){
	HX_STACK_FRAME("lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",131,0x6475c2cd)
	HX_STACK_THIS(this)
