...
{  hx::ObjectPtr< DOMRenderContext_obj > result = new DOMRenderContext_obj();
	result->__construct();
	return result;}
...
Dynamic DOMRenderContext_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic DOMRenderContext_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 2:
...
{
	outFields->push(HX_CSTRING("accessKey"));
	outFields->push(HX_CSTRING("align"));
	outFields->push(HX_CSTRING("attributes"));
	outFields->push(HX_CSTRING("baseURI"));
	...
	outFields->push(HX_CSTRING("contentEditable"));
	outFields->push(HX_CSTRING("dataset"));
	outFields->push(HX_CSTRING("dir"));
	outFields->push(HX_CSTRING("draggable"));
	outFields->push(HX_CSTRING("dropzone"));
	...
	outFields->push(HX_CSTRING("innerText"));
	outFields->push(HX_CSTRING("isContentEditable"));
	outFields->push(HX_CSTRING("lang"));
	outFields->push(HX_CSTRING("lastChild"));
	outFields->push(HX_CSTRING("lastElementChild"));
	outFields->push(HX_CSTRING("localName"));
	outFields->push(HX_CSTRING("namespaceURI"));
	...
	outFields->push(HX_CSTRING("onabort"));
	outFields->push(HX_CSTRING("onbeforecopy"));
	outFields->push(HX_CSTRING("onbeforecut"));
	outFields->push(HX_CSTRING("onbeforepaste"));
	outFields->push(HX_CSTRING("onblur"));
	outFields->push(HX_CSTRING("onchange"));
	outFields->push(HX_CSTRING("onclick"));
	outFields->push(HX_CSTRING("oncontextmenu"));
	outFields->push(HX_CSTRING("oncopy"));
	outFields->push(HX_CSTRING("oncut"));
	outFields->push(HX_CSTRING("ondblclick"));
	outFields->push(HX_CSTRING("ondrag"));
	outFields->push(HX_CSTRING("ondragend"));
	outFields->push(HX_CSTRING("ondragenter"));
	outFields->push(HX_CSTRING("ondragleave"));
	outFields->push(HX_CSTRING("ondragover"));
	outFields->push(HX_CSTRING("ondragstart"));
	outFields->push(HX_CSTRING("ondrop"));
	outFields->push(HX_CSTRING("onerror"));
	outFields->push(HX_CSTRING("onfocus"));
	outFields->push(HX_CSTRING("onfullscreenchange"));
	outFields->push(HX_CSTRING("onfullscreenerror"));
	outFields->push(HX_CSTRING("oninput"));
	outFields->push(HX_CSTRING("oninvalid"));
	outFields->push(HX_CSTRING("onkeydown"));
	outFields->push(HX_CSTRING("onkeypress"));
	outFields->push(HX_CSTRING("onkeyup"));
	outFields->push(HX_CSTRING("onload"));
	outFields->push(HX_CSTRING("onmousedown"));
	outFields->push(HX_CSTRING("onmousemove"));
	outFields->push(HX_CSTRING("onmouseout"));
	outFields->push(HX_CSTRING("onmouseover"));
	outFields->push(HX_CSTRING("onmouseup"));
	outFields->push(HX_CSTRING("onmousewheel"));
	outFields->push(HX_CSTRING("onpaste"));
	outFields->push(HX_CSTRING("onreset"));
	outFields->push(HX_CSTRING("onscroll"));
	outFields->push(HX_CSTRING("onsearch"));
	outFields->push(HX_CSTRING("onselect"));
	outFields->push(HX_CSTRING("onselectstart"));
	outFields->push(HX_CSTRING("onsubmit"));
	outFields->push(HX_CSTRING("ontouchcancel"));
	...
	outFields->push(HX_CSTRING("outerText"));
	outFields->push(HX_CSTRING("ownerDocument"));
	outFields->push(HX_CSTRING("parentElement"));
	...
	outFields->push(HX_CSTRING("pseudo"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,accessKey),HX_CSTRING("accessKey")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,align),HX_CSTRING("align")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,attributes),HX_CSTRING("attributes")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,baseURI),HX_CSTRING("baseURI")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,childElementCount),HX_CSTRING("childElementCount")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,childNodes),HX_CSTRING("childNodes")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,children),HX_CSTRING("children")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,classList),HX_CSTRING("classList")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,className),HX_CSTRING("className")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,clientHeight),HX_CSTRING("clientHeight")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,clientLeft),HX_CSTRING("clientLeft")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,clientTop),HX_CSTRING("clientTop")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,clientWidth),HX_CSTRING("clientWidth")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,contentEditable),HX_CSTRING("contentEditable")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,dataset),HX_CSTRING("dataset")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,dir),HX_CSTRING("dir")},
	{hx::fsBool,(int)offsetof(DOMRenderContext_obj,draggable),HX_CSTRING("draggable")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,dropzone),HX_CSTRING("dropzone")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,firstChild),HX_CSTRING("firstChild")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,firstElementChild),HX_CSTRING("firstElementChild")},
	{hx::fsBool,(int)offsetof(DOMRenderContext_obj,hidden),HX_CSTRING("hidden")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,id),HX_CSTRING("id")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,innerHTML),HX_CSTRING("innerHTML")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,innerText),HX_CSTRING("innerText")},
	{hx::fsBool,(int)offsetof(DOMRenderContext_obj,isContentEditable),HX_CSTRING("isContentEditable")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,lang),HX_CSTRING("lang")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,lastChild),HX_CSTRING("lastChild")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,lastElementChild),HX_CSTRING("lastElementChild")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,localName),HX_CSTRING("localName")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,namespaceURI),HX_CSTRING("namespaceURI")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,nextElementSibling),HX_CSTRING("nextElementSibling")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,nextSibling),HX_CSTRING("nextSibling")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,nodeName),HX_CSTRING("nodeName")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,nodeType),HX_CSTRING("nodeType")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,nodeValue),HX_CSTRING("nodeValue")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,offsetHeight),HX_CSTRING("offsetHeight")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,offsetLeft),HX_CSTRING("offsetLeft")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,offsetParent),HX_CSTRING("offsetParent")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,offsetTop),HX_CSTRING("offsetTop")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,offsetWidth),HX_CSTRING("offsetWidth")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onabort),HX_CSTRING("onabort")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onbeforecopy),HX_CSTRING("onbeforecopy")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onbeforecut),HX_CSTRING("onbeforecut")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onbeforepaste),HX_CSTRING("onbeforepaste")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onblur),HX_CSTRING("onblur")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onchange),HX_CSTRING("onchange")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onclick),HX_CSTRING("onclick")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,oncontextmenu),HX_CSTRING("oncontextmenu")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,oncopy),HX_CSTRING("oncopy")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,oncut),HX_CSTRING("oncut")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondblclick),HX_CSTRING("ondblclick")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondrag),HX_CSTRING("ondrag")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondragend),HX_CSTRING("ondragend")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondragenter),HX_CSTRING("ondragenter")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondragleave),HX_CSTRING("ondragleave")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondragover),HX_CSTRING("ondragover")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondragstart),HX_CSTRING("ondragstart")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ondrop),HX_CSTRING("ondrop")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onerror),HX_CSTRING("onerror")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onfocus),HX_CSTRING("onfocus")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onfullscreenchange),HX_CSTRING("onfullscreenchange")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onfullscreenerror),HX_CSTRING("onfullscreenerror")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,oninput),HX_CSTRING("oninput")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,oninvalid),HX_CSTRING("oninvalid")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onkeydown),HX_CSTRING("onkeydown")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onkeypress),HX_CSTRING("onkeypress")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onkeyup),HX_CSTRING("onkeyup")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onload),HX_CSTRING("onload")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onmousedown),HX_CSTRING("onmousedown")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onmousemove),HX_CSTRING("onmousemove")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onmouseout),HX_CSTRING("onmouseout")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onmouseover),HX_CSTRING("onmouseover")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onmouseup),HX_CSTRING("onmouseup")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onmousewheel),HX_CSTRING("onmousewheel")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onpaste),HX_CSTRING("onpaste")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onreset),HX_CSTRING("onreset")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onscroll),HX_CSTRING("onscroll")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onsearch),HX_CSTRING("onsearch")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onselect),HX_CSTRING("onselect")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onselectstart),HX_CSTRING("onselectstart")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,onsubmit),HX_CSTRING("onsubmit")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ontouchcancel),HX_CSTRING("ontouchcancel")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ontouchend),HX_CSTRING("ontouchend")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ontouchmove),HX_CSTRING("ontouchmove")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ontouchstart),HX_CSTRING("ontouchstart")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,outerHTML),HX_CSTRING("outerHTML")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,outerText),HX_CSTRING("outerText")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,ownerDocument),HX_CSTRING("ownerDocument")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,parentElement),HX_CSTRING("parentElement")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,parentNode),HX_CSTRING("parentNode")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,prefix),HX_CSTRING("prefix")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,previousElementSibling),HX_CSTRING("previousElementSibling")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,previousSibling),HX_CSTRING("previousSibling")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,pseudo),HX_CSTRING("pseudo")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,scrollHeight),HX_CSTRING("scrollHeight")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,scrollLeft),HX_CSTRING("scrollLeft")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,scrollTop),HX_CSTRING("scrollTop")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,scrollWidth),HX_CSTRING("scrollWidth")},
	{hx::fsBool,(int)offsetof(DOMRenderContext_obj,spellcheck),HX_CSTRING("spellcheck")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DOMRenderContext_obj,style),HX_CSTRING("style")},
	{hx::fsInt,(int)offsetof(DOMRenderContext_obj,tabIndex),HX_CSTRING("tabIndex")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,tagName),HX_CSTRING("tagName")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,textContent),HX_CSTRING("textContent")},
	{hx::fsString,(int)offsetof(DOMRenderContext_obj,title),HX_CSTRING("title")},
	{hx::fsBool,(int)offsetof(DOMRenderContext_obj,translate),HX_CSTRING("translate")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static ::String sMemberFields[] = {
	HX_CSTRING("accessKey"),
	HX_CSTRING("align"),
	...
	HX_CSTRING("innerText"),
	HX_CSTRING("isContentEditable"),
	HX_CSTRING("lang"),
	HX_CSTRING("lastChild"),
	HX_CSTRING("lastElementChild"),
	HX_CSTRING("localName"),
	HX_CSTRING("namespaceURI"),
	...
	HX_CSTRING("onabort"),
	HX_CSTRING("onbeforecopy"),
	HX_CSTRING("onbeforecut"),
	HX_CSTRING("onbeforepaste"),
	HX_CSTRING("onblur"),
	HX_CSTRING("onchange"),
	HX_CSTRING("onclick"),
	HX_CSTRING("oncontextmenu"),
	HX_CSTRING("oncopy"),
	HX_CSTRING("oncut"),
	HX_CSTRING("ondblclick"),
	HX_CSTRING("ondrag"),
	HX_CSTRING("ondragend"),
	HX_CSTRING("ondragenter"),
	HX_CSTRING("ondragleave"),
	HX_CSTRING("ondragover"),
	HX_CSTRING("ondragstart"),
	HX_CSTRING("ondrop"),
	HX_CSTRING("onerror"),
	HX_CSTRING("onfocus"),
	HX_CSTRING("onfullscreenchange"),
	HX_CSTRING("onfullscreenerror"),
	HX_CSTRING("oninput"),
	HX_CSTRING("oninvalid"),
	...
	HX_CSTRING("outerText"),
	HX_CSTRING("ownerDocument"),
	HX_CSTRING("parentElement"),
	...
	HX_CSTRING("spellcheck"),
	HX_CSTRING("style"),
	HX_CSTRING("tabIndex"),
	HX_CSTRING("tagName"),
	HX_CSTRING("textContent"),
	HX_CSTRING("title"),
	...
	HX_CSTRING("compareDocumentPosition"),
	HX_CSTRING("contains"),
	HX_CSTRING("dispatchEvent"),
	HX_CSTRING("focus"),
	HX_CSTRING("getAttribute"),
	HX_CSTRING("getAttributeNS"),
	HX_CSTRING("getAttributeNode"),
	HX_CSTRING("getAttributeNodeNS"),
	HX_CSTRING("getBoundingClientRect"),
	HX_CSTRING("getClientRects"),
	HX_CSTRING("getElementsByClassName"),
	HX_CSTRING("getElementsByTagName"),
	HX_CSTRING("getElementsByTagNameNS"),
	HX_CSTRING("hasAttribute"),
	HX_CSTRING("hasAttributeNS"),
	HX_CSTRING("hasAttributes"),
	HX_CSTRING("hasChildNodes"),
	HX_CSTRING("insertAdjacentElement"),
	HX_CSTRING("insertAdjacentHTML"),
	HX_CSTRING("insertAdjacentText"),
	HX_CSTRING("insertBefore"),
	HX_CSTRING("isDefaultNamespace"),
	HX_CSTRING("isEqualNode"),
	HX_CSTRING("isSameNode"),
	HX_CSTRING("isSupported"),
	HX_CSTRING("lookupNamespaceURI"),
	HX_CSTRING("lookupPrefix"),
	HX_CSTRING("matchesSelector"),
	HX_CSTRING("normalize"),
	HX_CSTRING("querySelector"),
	HX_CSTRING("querySelectorAll"),
	HX_CSTRING("remove"),
	HX_CSTRING("removeAttribute"),
	HX_CSTRING("removeAttributeNS"),
	HX_CSTRING("removeAttributeNode"),
	HX_CSTRING("removeChild"),
	HX_CSTRING("removeEventListener"),
	HX_CSTRING("replaceChild"),
	HX_CSTRING("requestFullScreen"),
	HX_CSTRING("requestFullscreen"),
	HX_CSTRING("requestPointerLock"),
	HX_CSTRING("scrollByLines"),
	HX_CSTRING("scrollByPages"),
	HX_CSTRING("scrollIntoView"),
	HX_CSTRING("scrollIntoViewIfNeeded"),
	HX_CSTRING("setAttribute"),
	HX_CSTRING("setAttributeNS"),
	HX_CSTRING("setAttributeNode"),
	HX_CSTRING("setAttributeNodeNS"),
	String(null()) };
...
Class DOMRenderContext_obj::__mClass;

void DOMRenderContext_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("lime.graphics.DOMRenderContext"), hx::TCanCast< DOMRenderContext_obj> ,sStaticFields,sMemberFields,
...
void DOMRenderContext_obj::__boot()
{
}
