...
class HXCPP_CLASS_ATTRIBUTES  HTML5AudioContext_obj : public hx::Object{
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("HTML5AudioContext"); }
		...
		virtual int getAudioDecodedByteCount( ::lime::audio::AudioBuffer buffer);
		Dynamic getAudioDecodedByteCount_dyn();
		...
		virtual Dynamic getController( ::lime::audio::AudioBuffer buffer);
		...
		virtual Float getInitialTime( ::lime::audio::AudioBuffer buffer);
		Dynamic getInitialTime_dyn();

		virtual bool getLoop( ::lime::audio::AudioBuffer buffer);
		Dynamic getLoop_dyn();

		virtual ::String getMediaGroup( ::lime::audio::AudioBuffer buffer);
		Dynamic getMediaGroup_dyn();
		...
		virtual Void setController( ::lime::audio::AudioBuffer buffer,Dynamic value);
		Dynamic setController_dyn();
		...
		virtual Void setMediaGroup( ::lime::audio::AudioBuffer buffer,::String value);
		Dynamic setMediaGroup_dyn();
