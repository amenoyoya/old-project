...
class HXCPP_CLASS_ATTRIBUTES  StencilManager_obj : public hx::Object{
	...
	public:
		...
		int stencilMask;
		virtual Void prepareGraphics( ::openfl::_internal::renderer::opengl::utils::GLBucketData fill,::openfl::_internal::renderer::RenderSession renderSession,::openfl::geom::Point projection,::lime::utils::Float32Array translationMatrix);
		Dynamic prepareGraphics_dyn();

		virtual Void pushBucket( ::openfl::_internal::renderer::opengl::utils::GLBucket bucket,::openfl::_internal::renderer::RenderSession renderSession,::openfl::geom::Point projection,::lime::utils::Float32Array translationMatrix,Dynamic isMask);
