...
{
HX_STACK_FRAME("haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","C:\\App\\Haxe-3.1.3\\haxe\\std/haxe/ds/BalancedTree.hx",220,0xc905d2c7)
HX_STACK_THIS(this)
HX_STACK_ARG(l,"l")
HX_STACK_ARG(k,"k")
HX_STACK_ARG(v,"v")
	...
	if (((h == (int)-1))){
		struct _Function_2_1{
			inline static int Block( hx::ObjectPtr< ::haxe::ds::TreeNode_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\App\\Haxe-3.1.3\\haxe\\std/haxe/ds/BalancedTree.hx",226,0xc905d2c7)
				{
					HX_STACK_LINE(226)
