...
STRING_LITERAL(TMP28, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP23 = mulInt64((*b), IL64(10));
				TMP24 = subInt(((NI) (((NU8)(s->data[i])))), 48);
				TMP25 = subInt64((NI64)(TMP23), ((NI64) ((NI32)(TMP24))));
				(*b) = (NI64)(TMP25);
				i = addInt(i, 1);
				{
					while (1) {
		...
		TMP26 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP26);
		TMP27 = subInt(i, start);
		result = (NI32)(TMP27);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_91969 = 0;
		e_91969 = (overflowerror3243*) newObj((&NTI22201), sizeof(overflowerror3243));
		(*e_91969).Sup.Sup.Sup.m_type = (&NTI3243);
		LOC9 = 0;
		LOC9 = (*e_91969).Sup.Sup.message; (*e_91969).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP28));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		raiseException((Exception*)e_91969, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
