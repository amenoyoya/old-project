...
static void constructor (LexState *ls, expdesc *t) {
  /* constructor -> TK_DEFTBL [ field { sep field } [sep] ] '}'
     sep -> ',' | ';' */
  FuncState *fs = ls->fs;
...
static void funcargs (LexState *ls, expdesc *f, int line) {
  ...
  switch (ls->t.token) {
    ...
    case TK_DEFTBL: {  /* funcargs -> constructor */
      constructor(ls, &args);
      break;
    }
...
static void suffixedexp (LexState *ls, expdesc *v) {
  /* suffixedexp ->
       primaryexp { '.' NAME | '[' exp ']' | TK_METHOD NAME funcargs | funcargs } */
  FuncState *fs = ls->fs;
  int line = ls->linenumber;
  primaryexp(ls, v);
  for (;;) {
    switch (ls->t.token) {
      ...
      case '(': case TK_STRING: case TK_DEFTBL: {  /* funcargs */
